...
source(paste0(dir_do,"prelims_2011.R"))
# Scraping starts
source(paste0(dir_do,"Scrape_2011.R"))
#tryCatch({source(paste0(dir_do,"Scrape_2011.R"))}, silent=FALSE,error=send_error_email())
