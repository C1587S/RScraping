...
# Case 1
# Begins with mstematicas question number: 18, 53, 15
#---------------------------------------------------------------------------------------------------------------------------------------------------- 
...
# Case 2
# Begins with mstematicas question number: 17 14 16
#---------------------------------------------------------------------------------------------------------------------------------------------------- 
# List of Español questions
# T1: Aspectos semánticos y sintácticos de los textos
Esp_first_col_T1  <- c(); Esp_second_col_T1 <- c()
...
for (i in seq(1,10, by=1)){
  Esp_first_col_T1[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[3]/td[2]/table/tbody/tr[1]/td[",
                 as.character(i), "]/a", sep="")
  Esp_first_col_T3[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[7]/td[2]/table/tbody/tr[1]/td[",
                 as.character(i), "]/a", sep="")
  Esp_first_col_T5[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[11]/td[2]/table/tbody/tr[1]/td[",
                 as.character(i), "]/a", sep="")
}
for (i in seq(1,8, by=1)){
  Esp_second_col_T3[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[7]/td[2]/table/tbody/tr[1]/td[",
                 as.character(i), "]/a", sep="")
}
for (i in seq(1,7, by=1)){
  Esp_first_col_T4[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[9]/td[2]/table/tbody/tr/td[",
...
Esp_second_col_T5[[1]] <- "/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[11]/td[2]/table/tbody/tr[2]/td/a"
# paste all the elements
Esp_T1 <- c(Esp_first_col_T1, Esp_second_col_T1)
Esp_T2 <- c(Esp_first_col_T2)
Esp_T3 <- c(Esp_first_col_T3, Esp_second_col_T3)
...
for (i in seq(1,10, by=1)){
  Mat_first_col_T5[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[11]/td[2]/table/tbody/tr[1]/td[",
                 as.character(i), "]/a", sep="")
  Mat_first_col_T6[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[13]/td[2]/table/tbody/tr[1]/td[",
                 as.character(i), "]/a", sep="")
}
for (i in seq(1,8, by=1)){
  Mat_second_col_T6[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[13]/td[2]/table/tbody/tr[2]/td[",
...
for (i in seq(1,4, by=1)){
  Mat_first_col_T1[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[3]/td[2]/table/tbody/tr/td[",
                 as.character(i), "]/a", sep="")
  Mat_first_col_T3[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[7]/td[2]/table/tbody/tr/td[",
                 as.character(i), "]/a", sep="")
  Mat_first_col_T4[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[9]/td[2]/table/tbody/tr/td[",
...
for (i in seq(1,2, by=1)){
  Mat_second_col_T5[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[11]/td[2]/table/tbody/tr[2]/td[",
                 as.character(i), "]/a", sep="")
}
...
# Case 3
# Begins with mstematicas question number: 21 16 17
#---------------------------------------------------------------------------------------------------------------------------------------------------- 
# List of Español questions
# T1: Aspectos semánticos y sintácticos de los textos
Esp_first_col_T1  <- c(); Esp_second_col_T1 <- c()
...
Esp_first_col_T4 <- c(); Esp_second_col_T4 <- c()
# T5: Búsqueda y manejo de información
Esp_first_col_T5 <- c()

for (i in seq(1,10, by=1)){
  Esp_first_col_T1[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[3]/td[2]/table/tbody/tr[1]/td[",
                 as.character(i), "]/a", sep="")
  Esp_first_col_T2[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[5]/td[2]/table/tbody/tr[1]/td[",
                 as.character(i), "]/a", sep="")
  Esp_second_col_T2[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[5]/td[2]/table/tbody/tr[2]/td[",
                 as.character(i), "]/a", sep="")
  Esp_first_col_T4[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[9]/td[2]/table/tbody/tr[1]/td[",
                 as.character(i), "]/a", sep="")
}
for (i in seq(1,6, by=1)){
  Esp_second_col_T4[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[9]/td[2]/table/tbody/tr[2]/td[",
                 as.character(i), "]/a", sep="")
}
for (i in seq(1,4, by=1)){
  Esp_third_col_T2[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[5]/td[2]/table/tbody/tr[3]/td[",
                 as.character(i), "]/a", sep="")
  Esp_first_col_T3[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[7]/td[2]/table/tbody/tr/td[",
                 as.character(i), "]/a", sep="")
}

Esp_second_col_T1[[1]] <- "/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[3]/td[2]/table/tbody/tr[2]/td/a"
Esp_first_col_T5[[1]] <- "/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[11]/td[2]/table/tbody/tr/td/a"
...
for (i in seq(1,10, by=1)){
  Mat_first_col_T3[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[7]/td[2]/table/tbody/tr[1]/td[",
                 as.character(i), "]/a", sep="")
  Mat_first_col_T5[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[11]/td[2]/table/tbody/tr[1]/td[",
                 as.character(i), "]/a", sep="")
  Mat_first_col_T6[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[13]/td[2]/table/tbody/tr[1]/td[",
...
for (i in seq(1,3, by=1)){
  Mat_second_col_T3[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[7]/td[2]/table/tbody/tr[2]/td[",
                 as.character(i), "]/a", sep="")
  Mat_first_col_T4[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[9]/td[2]/table/tbody/tr/td[",
                 as.character(i), "]/a", sep="")
  Mat_first_col_T7[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[15]/td[2]/table/tbody/tr/td[",
...
Mat_second_col_T5[[1]] <- "/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[11]/td[2]/table/tbody/tr[2]/td/a"
Mat_second_col_T6[[1]] <- "/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[13]/td[2]/table/tbody/tr[2]/td/a"
...
# Case 4
# Begins with mstematicas question number: 20 90 16
#---------------------------------------------------------------------------------------------------------------------------------------------------- 
# List of Español questions
# T1: Aspectos semánticos y sintácticos de los textos
Esp_first_col_T1  <- c(); Esp_second_col_T1 <- c()
...
Esp_second_col_T1[[1]] <- "/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[3]/td[2]/table/tbody/tr[2]/td/a"
Esp_third_col_T2[[1]] <- "/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[5]/td[2]/table/tbody/tr[3]/td/a"
# paste all the elements
...
for (i in seq(1,10, by=1)){
  Mat_first_col_T1[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[3]/td[2]/table/tbody/tr[1]/td[",
                 as.character(i), "]/a", sep="")
  Mat_first_col_T2[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[5]/td[2]/table/tbody/tr[1]/td[",
                 as.character(i), "]/a", sep="")
  Mat_first_col_T6[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[13]/td[2]/table/tbody/tr[1]/td[",
                 as.character(i), "]/a", sep="")
  Mat_second_col_T6[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[13]/td[2]/table/tbody/tr[2]/td[",
...
for (i in seq(1,7, by=1)){
  Mat_second_col_T1[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[3]/td[2]/table/tbody/tr[2]/td[",
                 as.character(i), "]/a", sep="")
  Mat_first_col_T5[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[11]/td[2]/table/tbody/tr/td[",
                 as.character(i), "]/a", sep="")
}
...
for (i in seq(1,2, by=1)){
  Mat_second_col_T2[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[5]/td[2]/table/tbody/tr[2]/td[",
                 as.character(i), "]/a", sep="")
  Mat_first_col_T4[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[9]/td[2]/table/tbody/tr/td[",
                 as.character(i), "]/a", sep="")
  Mat_first_col_T7[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[15]/td[2]/table/tbody/tr/td[",
...
# Case 5
# Begins with mstematicas question number: 21 128 18
#---------------------------------------------------------------------------------------------------------------------------------------------------- 
# List of Español questions
# T1: Analizar y valorar críticamente los medios de comunicación
Esp_first_col_T1  <- c(); 
# T2: Hacer el seguimiento de algún subgénero, temática o movimiento
Esp_first_col_T2 <- c()
# T3: Leer para conocer otros pueblos
Esp_first_col_T3 <- c(); 
...
Esp_first_col_T5 <- c()
# T6: Obtener y organizar información
Esp_first_col_T6 <- c(); Esp_second_col_T6 <- c();
# T7: Participar en eventos comunicativos formales para compartir información
Esp_first_col_T7 <- c();
# T8: Participar en experiencias teatrales
Esp_first_col_T8 <- c();
# T9: Revisar y reescribir textos producidos en distintas áreas de estudio
Esp_first_col_T9 <- c();

for (i in seq(1,10, by=1)){
  Esp_first_col_T6[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[13]/td[2]/table/tbody/tr[1]/td[",
                 as.character(i), "]/a", sep="")
}
for (i in seq(1,9, by=1)){
  Esp_first_col_T8[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[17]/td[2]/table/tbody/tr/td[",
                                 as.character(i), "]/a", sep="")
}
for (i in seq(1,7, by=1)){
  Esp_first_col_T9[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[19]/td[2]/table/tbody/tr/td[",
                                 as.character(i), "]/a", sep="")
}
for (i in seq(1,5, by=1)){
  Esp_first_col_T5[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[11]/td[2]/table/tbody/tr/td[",
...
for (i in seq(1,4, by=1)){
  Esp_first_col_T1[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[3]/td[2]/table/tbody/tr/td[",
                 as.character(i), "]/a", sep="")
  Esp_first_col_T3[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[7]/td[2]/table/tbody/tr/td[",
                 as.character(i), "]/a", sep="")
  Esp_first_col_T4[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[9]/td[2]/table/tbody/tr/td[",
...
for (i in seq(1,2, by=1)){
  Esp_second_col_T6[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[13]/td[2]/table/tbody/tr[2]/td[",
                 as.character(i), "]/a", sep="")
  Esp_first_col_T7[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[15]/td[2]/table/tbody/tr/td[",
                 as.character(i), "]/a", sep="")
}
...
pregs_esp5 <- c(Esp_T1, Esp_T2, Esp_T3, Esp_T4, Esp_T5, Esp_T6, Esp_T7, Esp_T8, Esp_T9)
...
for (i in seq(1,3, by=1)){
  Mat_first_col_T8[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[17]/td[2]/table/tbody/tr/td[",
                 as.character(i), "]/a", sep="")
}

Mat_second_col_T1[[1]] <- "/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[3]/td[2]/table/tbody/tr[2]/td/a"
Mat_second_col_T5[[1]] <- "/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[11]/td[2]/table/tbody/tr[2]/td/a"
...
pregs_mat5 <- c(Mat_T1,Mat_T2,Mat_T3,Mat_T4,Mat_T5,Mat_T6,Mat_T7,Mat_T8)

# Case 6
# Begins with mstematicas question number: 19 15 136
#---------------------------------------------------------------------------------------------------------------------------------------------------- 
# List of Español questions
# T1: Analizar y valorar críticamente los medios de comunicación
Esp_first_col_T1  <- c(); 
...
for (i in seq(1,6, by=1)){
  Esp_second_col_T5[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[11]/td[2]/table/tbody/tr[2]/td[",
                 as.character(i), "]/a", sep="")
  Esp_first_col_T7[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[15]/td[2]/table/tbody/tr/td[",
                 as.character(i), "]/a", sep="")
}
...
Esp_second_col_T6[[1]] <- "/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[13]/td[2]/table/tbody/tr[2]/td/a"
...
Esp_T6 <- c(Esp_first_col_T6, Esp_second_col_T6)
Esp_T7 <- c(Esp_first_col_T7)
pregs_esp6 <- c(Esp_T1, Esp_T2, Esp_T3, Esp_T4, Esp_T5, Esp_T6, Esp_T7)
#--------------------------------------
# List of Matemáticas questions
## T1: Análisis de la información
Mat_first_col_T1  <- c()
...
for (i in seq(1,10, by=1)){
  Mat_first_col_T2[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[5]/td[2]/table/tbody/tr[1]/td[",
                 as.character(i), "]/a", sep="")
  Mat_first_col_T4[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[9]/td[2]/table/tbody/tr[1]/td[",
                 as.character(i), "]/a", sep="")
  Mat_first_col_T6[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[13]/td[2]/table/tbody/tr[1]/td[",
                 as.character(i), "]/a", sep="")
}
...
Mat_second_col_T2[[1]] <- "/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[5]/td[2]/table/tbody/tr[2]/td/a"
Mat_second_col_T4[[1]] <- "/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[9]/td[2]/table/tbody/tr[2]/td/a"
...
# Case 7
# Begins with mstematicas question number: 98 15 129
#---------------------------------------------------------------------------------------------------------------------------------------------------- 
# List of Español questions
...
Esp_T7 <- c(Esp_first_col_T7)
Esp_T8 <- c(Esp_first_col_T8)
pregs_esp7 <- c(Esp_T1, Esp_T2, Esp_T3, Esp_T4, Esp_T5, Esp_T6, Esp_T7, Esp_T8)
...
for (i in seq(1,4, by=1)){
  Mat_second_col_T4[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[9]/td[2]/table/tbody/tr[2]/td[",
                 as.character(i), "]/a", sep="")
  Mat_second_col_T5[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[11]/td[2]/table/tbody/tr[2]/td[",
                 as.character(i), "]/a", sep="")
  Mat_first_col_T6[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[13]/td[2]/table/tbody/tr/td[",
...
Mat_second_col_T3[[1]] <- "/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[7]/td[2]/table/tbody/tr[2]/td/a"
# paste all the elements
Mat_T1 <- c(Mat_first_col_T1)
Mat_T2 <- c(Mat_first_col_T2, Mat_second_col_T2)
Mat_T3 <- c(Mat_first_col_T3, Mat_second_col_T3)
Mat_T4 <- c(Mat_first_col_T4, Mat_second_col_T4)
Mat_T5 <- c(Mat_first_col_T5, Mat_second_col_T4)
Mat_T6 <- c(Mat_first_col_T6)
Mat_T7 <- c(Mat_first_col_T7)
pregs_mat7 <- c(Mat_T1, Mat_T2, Mat_T3, Mat_T4, Mat_T5, Mat_T6, Mat_T7)
