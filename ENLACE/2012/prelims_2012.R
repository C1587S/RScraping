...
for (i in seq(1,7, by=1)){
  Esp_second_col_T3[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[9]/td[2]/table/tbody/tr/td[",
                                  as.character(i), "]/a", sep="")
}
...
for (i in seq(1,5, by=1)){
  Mat_second_col_T6[[i]] <- paste("/html/body/form/div[3]/div/table/tbody/tr[7]/td/table[1]/tbody/tr[13]/td[2]/table/tbody/tr/td[",
                                  as.character(i), "]/a", sep="")
}
for (i in seq(1,4, by=1)){
