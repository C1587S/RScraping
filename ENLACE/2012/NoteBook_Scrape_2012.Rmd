...
## Open the csv file
```{r}
rawData_2012 <- fread('/Users/c1587s/Dropbox/Webscrape_Puntajes/RawData/Basica2012.csv', header = FALSE, skip=1)
```
...
preguntas_mat <- c(Mat_T1,Mat_T2,Mat_T3,Mat_T4,Mat_T5,Mat_T6, Mat_T7)
```
...
```{r}
write.csv(DataBase, file="/Users/c1587s/Dropbox/Webscrape_Puntajes/CreatedData/2012/DataBase_ENLACE2012_Test.csv", row.names = FALSE)
...
subject <- "R scraping for ENLACE 2012"
body <- "R scraping for ENLACE 2012 is has stopped for a reason."                     
